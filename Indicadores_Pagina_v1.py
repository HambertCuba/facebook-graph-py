...
while i <= 10 :    
    ...
    if i==0:
        listafinal2=[[fecha2,cantidad_p21,page_impressions_unique,page_impressions_organic_unique,page_impressions_paid_unique,
                  ...
                  page_consumptions,page_video_views,page_video_complete_views_30s,page_daily_video_ad_break_earnings_by_crosspost_status
                  ]]
        hoja= '1i4R-Gg30GuuyIK3iP-xC5WoEH9wCYbCLX0zkd3uRbPI'
    ...
    if i==1:
        ...
        hoja='1W1LGJ1Div1cjcHa10iTs1KfTK8kZwOwRF3ecnuLlHNo'
        subir_ipagina(listafinal2,hoja,name)
    ...
    if i==2:
        ...
        hoja='1dtY-hhDSv5o8sCSRbo-VlWCsw_tWpcqXp9Bsu_ujx2w'
        subir_ipagina(listafinal2,hoja,name)
    ...
    if i==3:
        ...
        hoja='1l8_KEVavN2Dz_aVC5CMEWAoWZJisgrfupHeAufkTrPI'
        subir_ipagina(listafinal2,hoja,name)
    ...
    if i==4:
        ...
        hoja='1SkPx2TrIiibhF6kUN9PSM6vmM8Ic-jV0Kr6qa1-gRbs'
        subir_ipagina(listafinal2,hoja,name)
    ...
    if i==6:
        ...
        hoja='1-35zxeUSLshm-Kb-YcnTpOFtjIu2JuL-39Z6_swVYa4'
        subir_ipagina(listafinal2,hoja,name)
    ...
    if i==8:
        ...
        hoja='1LquJaL4qOjvK6JkBMqD2thVDe_qwxSQbyeW3g-CH7KA'
        subir_ipagina(listafinal2,hoja,name)
    ...
    if i==9:
        ...
        hoja='1sKYncJCL_ZlUZ-pKYfUz9naPg6MiL0WBOMdK1tzn0RE'
        subir_ipagina(listafinal2,hoja,name)
    ...
    if i==10:
        ...
        hoja='15_LMM5jmpQUFtNBbfQxNs7oJZq-HEuuZdmDl0Fu_wUo'
        subir_ipagina(listafinal2,hoja,name)
