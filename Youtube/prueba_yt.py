...
# now = datetime.today()
# PATH_LOG = '/home/ec2-pentaho/pentaho/unp/Facebook/videos_2/log/'
...
#         JSON_FILE = '/home/ec2-pentaho/pentaho/unp/Facebook/videos_2/proceso/cmsproyecto-1610655853990-aa4048eb3551.json'
...
while i<= 7:
    channel=canales[i]
    owned_apps = []
    api= 'https://www.googleapis.com/youtube/v3/search?key='+api_key+'&channelId='+channel+'&part=snippet,id&order=date'
    #print(api)
		...
		while item2 <= len(owned_apps_com):
			...
			try:
				...
				try:
					...
					dislikes=0
# 				try:
# 					favorite=responseprueba_1["items"][0]["statistics"]["favoriteCount"]
# 				except(ValueError,KeyError,ZeroDivisionError,NameError):
# 					favorite=0
				try:
			...
			fecha2=dateutil.parser.parse(fecha).date()
